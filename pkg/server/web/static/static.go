...
const (
	...
	static = `<h1 id="keeper">keeper</h1>
<h2 id="-">Общие требования</h2>
<p>keeper представляет собой клиент-серверную систему, позволяющую пользователю надёжно и безопасно хранить логины, пароли, бинарные данные и прочую приватную информацию.</p>
<p><img src="keeper.png" alt="keeper"  width="700" height="369" align="middle"></p>
